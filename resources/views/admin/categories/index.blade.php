        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form id="categoryForm" data-url="{{ route('admin.category') }}" enctype="multipart/form-data"
    ...
    <form id="categoryForm-edit" class="hidden fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
        ...
        <div>
            ...
            <input type="text" name="name" id="name-edit" required
                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-200 focus:outline-none">
            <p id="errorMsg-edit" class="hidden text-red-500 text-sm mt-1">Danh mục đã tồn tại</p>
        </div>

        <div>
            <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Mô tả</label>
            <input type="text" name="description" id="description-edit"
                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-200 focus:outline-none">
        </div>
        ...
        <div class="flex justify-end gap-2">
            ...
            <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition">Lưu</button>
        </div>
    </form>
